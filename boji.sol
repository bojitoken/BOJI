...
contract BOJI is Context, IERC20, Ownable
{
    ...
    //Min buy/sell amount - > 20T and it can't be changed
    uint256 public MIN_BUY_SELL_TXN_AMOUNT 	= 20000000000000;

    // buy/sell Max transaction limit - >  20T
    uint256 private _maxTxAmount 	= 20000000000000 * (10**9);
